...
import com.base.mvp.view.LifeCycleMvpActivity;
import com.business.R;
import com.business.constant.BusinessConstant;
import com.common.dialog.CustomProgress;
import com.common.log.KLog;
import com.common.permission.PermissionManager;
...
//            RxBus.get().register(this);
    ...
    private void setToolbarLightBackground() {
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(this, com.common.common.R.color.white));
    ...
    private void setStatusbarLightBackground() {
        StatusBarUtil.setStatusBarColor(this, ContextCompat.getColor(this, com.common.common.R.color.white));
    ...
    private void setToolbarDarkBackground() {
        ...
        TextView tvToolbarTitle = findViewById(R.id.tv_toolbar_center);
        TextView tvToolbarMore = findViewById(R.id.tv_toolbar_right);
        tvToolbarTitle.setTextColor(ContextCompat.getColor(this, com.common.common.R.color.white));
        tvToolbarMore.setTextColor(ContextCompat.getColor(this, R.color.color_text_main_17364E));
    ...
    protected void initToolbar() {
        ...
        mTvTitle = findViewById(R.id.tv_toolbar_center);
    ...
    public void showLoading() {
        ...
        if (!mCustomProgress.isShowing()) {
            mCustomProgress.show("loading", false, null);
        }
    }

    public void showLoading(String message) {
        if (!mCustomProgress.isShowing()) {
            mCustomProgress.show(message, false, null);
        }
    }
    ...
    protected boolean isUserLogin() {
        ...
        startActivityForResult(new Intent(this, LoginActivity.class), BusinessConstant.ActivityCode.RESULT_LOGIN_CODE_2);*/
        return false;
    }
...
//        MobclickAgent.onPause(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == BusinessConstant.ActivityCode.RESULT_OK &&
                requestCode == BusinessConstant.ActivityCode.RESULT_LOGIN_CODE_2) {
            loginRefreshData();
        }
    }
