...
import com.base.mvp.view.LifeCycleMvpFragment;
...
public abstract class BaseFragment extends LifeCycleMvpFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String params1 = savedInstanceState.getString(BusinessConstant.IntentKey.PARAMS_1);
    ...
    public boolean isUserLogin() {
        ...
        requireActivity().startActivityForResult(new Intent(getActivity(), LoginActivity.class), BusinessConstant.ActivityCode.REQUEST_CODE_10002);*/
        return false;
    }
...
//        MobclickAgent.onPageStart(StringUtil.valueOf(getClass().getName()));
    }
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        if (hidden) {
//            MobclickAgent.onPageEnd(StringUtil.valueOf(getClass().getName()));
            return;
        } else {
//            MobclickAgent.onPageStart(StringUtil.valueOf(getClass().getName()));
        }
