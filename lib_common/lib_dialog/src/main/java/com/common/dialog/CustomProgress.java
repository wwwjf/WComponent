...
public class CustomProgress extends Dialog {
    ...
    public void showLoading(CharSequence message, boolean cancelable, OnCancelListener cancelListener) {
        setTitle("");
        /*setContentView(R.layout.dialog_custom_loading);
        TextView txt = findViewById(R.id.tv_custom_loading_message);
    ...
    public void showLeftEnsure(String content,
        ...
        if (!TextUtils.isEmpty(cancelText)) {
            ...
            cancelBtn.setTextColor(mContext.getResources().getColor(com.common.common.R.color.black));
        }
        ...
        if (!TextUtils.isEmpty(ensureText)) {
            ...
            ensureBtn.setTextColor(mContext.getResources().getColor(com.common.common.R.color.black_30));
        }
